                ...
                episodes: [
                    {
                        ...
                        category: "Wars",
                        image: "https://images.unsplash.com/photo-1564396322457-3d8c08dbad7d?q=80&w=2070&auto=format&fit=crop",
                ...
                episodes: [
                    ...
                    },
                    {
                        ...
                        content: [
                            ...
                            { type: "normal", text: "Two and a million Soviet soldiers were encircling the city, unleashing a barrage of over a million shells within the first few days. The skyline was thick with black smoke; the Spree River was choked with debris. Above ground, the city was systematically reduced to ash." },
                            { type: "normal", text: "Defending the city was a ragged, desperate assortment of what remained of the German army, bolstered by the Volksturm—a militia consisting of old men and Hitler Youth boys, some as young as twelve, armed with panzerfausts and ordered to fight to the death." },
                            ...
                            { type: "normal", text: "The battle for Berlin was characterized by visceral, street-to-street combat. Civilians, caught in the crossfire, hid in flooded subway tunnels and ruined cellars, emerging only to find water or surrender to the vengeful Red Army." },
                            { type: "normal", text: "When the guns finally fell silent on May 2, the city was unrecognizable. Over 80,000 Soviet soldiers and upwards of 100,000 German defenders and civilians lay dead in the rubble." },
                            { type: "closing", text: "Empires do not fall quietly. They collapse in smoke." }
                        ]
                    }
                ]
            }
                ...
                episodes: [
                    ...
                    },
                    {
                        ...
                        content: [
                            ...
                            { type: "normal", text: "This brain drain was an economic and ideological disaster for the Soviet bloc. The solution was brutal: a 96-mile militarized barrier completely encircling West Berlin, suffocating escape." },
                            { type: "emphasis", text: "Families went to sleep together. They woke up divided." },
                            { type: "normal", text: "Over the next decades, the initial barbed wire was replaced by a sophisticated, lethal system. The 'Death Strip' featured 12-foot high concrete walls, anti-vehicle trenches, beds of nails, hundreds of guard towers, and trip-wire machine guns. East German border guards were given the *Schießbefehl*—the order to shoot to kill anyone attempting to cross." },
                            { type: "normal", text: "The human cost was devastating. Husbands were separated from wives, children from parents. Desperate individuals attempted escape via hot air balloons, ziplines, secret tunnels, and hidden compartments in cars. At least 140 people died attempting to cross, bleeding out in the Death Strip while guards watched." },
                            { type: "normal", text: "The Wall stood for 28 years as the ultimate physical manifestation of the Iron Curtain—a monument to a system that had to imprison its own people to survive." },
                            { type: "closing", text: "Walls do not just divide land. They divide memory." }
                        ]
                    },
                    {
                ...
                episodes: [
                    {
                        ...
                        content: [
                            { type: "lead", text: "Paris. 1793." },
                            { type: "normal", text: "The French Revolution had promised a new dawn of human rights based on 'Liberty, Equality, Fraternity.' But as foreign armies invaded and internal rebellions flared, the noble ideals of 1789 warped into profound paranoia." },
                            { type: "normal", text: "Power consolidated into the hands of the Committee of Public Safety, led by Maximilien Robespierre—a man so radically devoted to revolutionary purity he earned the nickname 'The Incorruptible.' Robespierre believed that terror was necessary to protect virtue." },
                            { type: "normal", text: "A new machine of industrial death was erected in the Place de la Révolution: the guillotine. It was democratic, ensuring nobles and peasants lost their heads with equal speed. Soon, the blade was falling with terrifying regularity." },
                            { type: "emphasis", text: "Revolution protects itself by destroying its enemies." },
                            { type: "normal", text: "The 'Law of Suspects' made it a treasonous offense to act, speak, or even think against the Revolution. Neighbors turned on neighbors. Simply not appearing enthusiastic enough about the republic could result in a death sentence. The trials of the Revolutionary Tribunal became mockeries of justice, often denying defendants legal counsel or the right to call witnesses." },
                            { type: "normal", text: "Over a 10-month period, roughly 17,000 people were officially executed across France, while tens of thousands more died in mass drownings in Nantes, or succumbed to disease in overflowing prisons. The victims were not just aristocrats; they were bakers, priests, intellectuals, and early supporters of the revolution." },
                            { type: "normal", text: "The cycle of violence accelerated until it consumed its own architects. Fearing they would be the next ones sent to the blade, members of the National Convention turned against Robespierre in the Thermidorian Reaction." },
